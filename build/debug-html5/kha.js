...
var ae_AudioClip = function(s) {
	...
	this.volume = 1.0;
	this.dirty = false;
	this.b = new kha_audio2_Buffer(ae_AudioManager.instance.sampleRate,2,ae_AudioManager.instance.sampleRate);
	this.channel = null;
	ae_Clip.call(this);
	var t = kha_Assets.sounds.get(s);
	if(t == null) {
		kha_Assets.loadSound(s,$bind(this,this.load),$bind(this,this.error),{ fileName : "ae/AudioClip.hx", lineNumber : 36, className : "ae.AudioClip", methodName : "new"});
	} else {
		this.snd = t;
		this.b.data = this.snd.uncompressedData;
		this.name = s;
		haxe_Log.trace(this.name,{ fileName : "ae/AudioClip.hx", lineNumber : 42, className : "ae.AudioClip", methodName : "new"});
	}
};
...
ae_AudioClip.prototype = $extend(ae_Clip.prototype,{
	...
	,error: function(error) {
		haxe_Log.trace(error,{ fileName : "ae/AudioClip.hx", lineNumber : 54, className : "ae.AudioClip", methodName : "error"});
	}
	,play: function() {
		var pitchDirty = false;
		this.snd.uncompressedData = this.b.data;
		if(this.snd != null && this.get_pitch() != this.lastPitch) {
			var this1 = new Float32Array(ae_AudioManager.instance.sampleRate * this.get_pitch() | 0);
			var t = this1;
			var _g = 0;
			var _g1 = t.length;
			while(_g < _g1) {
				var i = _g++;
				this.snd.uncompressedData[i] *= this.get_pitch();
			}
			pitchDirty = true;
			haxe_Log.trace("was here",{ fileName : "ae/AudioClip.hx", lineNumber : 67, className : "ae.AudioClip", methodName : "play"});
		}
		if(this.channel == null && this.snd != null || pitchDirty) {
			this.channel = kha_audio2_Audio1.play(this.snd,false);
			this.paused = false;
			this.lastPitch = this.get_pitch();
...
ae_AudioManager.prototype = {
	...
	,setTuning: function(tune) {
		if(tune == 0) {
			var _g = 0;
			var _g1 = ae_AudioManager.freqs.length;
			while(_g < _g1) {
				var i = _g++;
				var number = this.ref.get_first();
				if(i < this.ref.get_first()) {
					number = -(this.ref.get_first() - 21) + i;
				} else if(i > this.ref.get_first()) {
					number = i - (this.ref.get_first() - 21);
				}
				ae_AudioManager.freqs[i] = Math.pow(2,number * 0.083333333) * this.ref.get_second();
			}
		}
	}
	,toFreqs: function(m) {
		if(m >= 21 && m <= 108) {
			return ae_AudioManager.freqs[m - 21];
		}
		return 0.0;
	}
	...
	,register: function(event,object) {
		...
		if((event instanceof ae_IEvent)) {
			if(this.objects.h.__keys__[obj.__id__] == null) {
				var t = [];
				t.push(event);
				this.objects.set(obj,this.registered.length);
				this.registered.push(t);
			} else {
				this.registered[this.objects.h[obj.__id__]].push(event);
			}
			return true;
		}
		return false;
	...
	,unregister: function(name,object) {
		...
		var t = [];
		if(object != null && this.objects.h.__keys__[object.__id__] != null) {
			var _g = 0;
			var _g1 = this.registered[this.objects.h[object.__id__]];
			while(_g < _g1.length) {
				var e = _g1[_g];
				++_g;
			...
			while(_g2 < t.length) {
				var e1 = t[_g2];
				++_g2;
				HxOverrides.remove(this.registered[this.objects.h[object.__id__]],e1);
			}
		}
	}
	,update: function() {
...
ae_Input.__name__ = true;
ae_Input.onKeyDown = function(keyCode) {
	switch(keyCode) {
	case 65:
		ae_Input.note.push(60);
		break;
	case 68:
		ae_Input.note.push(64);
		break;
	case 83:
		ae_Input.note.push(62);
		break;
	case 87:
		ae_Input.note.push(61);
		break;
	default:
		return;
	}
...
ae_Oscillator.update = function(dt) {
	if(ae_Oscillator.channel.data == null) {
...
$hxClasses["ae.Pair"] = ae_Pair;
ae_Pair.__name__ = true;
ae_Pair.round = function(number,precision) {
	if(precision == null) {
		precision = 2;
	}
...
ae_Oscillator.buf = (function($this) {
	var $r;
	var this1 = new Float32Array(ae_AudioManager.instance.sampleRate);
	$r = this1;
	return $r;
}(this));
