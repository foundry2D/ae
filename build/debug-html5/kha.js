...
Main.update = function() {
	haxe_Log.trace(ae_AudioManager.instance.ToFreqs(ae__$Notes_Notes_$Impl_$.toIntMap.get(24)),{ fileName : "Main.hx", lineNumber : 12, className : "Main", methodName : "update"});
};
...
ae_AudioManager.prototype = {
	...
	,ToFreqs: function(i) {
		if(i >= 21) {
			return ae_AudioManager.freqs[i - 21];
		}
		return 0.0;
	}
